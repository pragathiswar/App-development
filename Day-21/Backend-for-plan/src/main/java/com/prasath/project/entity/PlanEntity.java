package com.prasath.project.entity;
...
public class PlanEntity {
			...
			public PlanEntity(int id, String firstname, String lastname, String email, String startdate, String enddate, String destination, double estimatedexpenses, String traveldescription) {
				super();
				this.id = id;
